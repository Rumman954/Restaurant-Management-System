...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-black/20 bg-[#ee6e73] text-white shadow-sm">
      <nav className="mx-auto flex h-[36px] w-full items-center justify-between px-5 md:px-6">
        <Link to="/" className="brand-logo old-nav-logo-padding text-[33px] leading-none text-white">
          Resturant
        </Link>
